    ...
    <div className="bg-slate-800 rounded-lg p-6 border border-slate-600">
      ...
      <div className="flex flex-col space-y-3 sm:flex-row sm:items-center sm:justify-between sm:space-y-0 mb-4">
        <div className="flex flex-col sm:flex-row sm:items-center sm:space-x-3">
          ...
          <span className="text-xs bg-green-600 text-white px-2 py-1 rounded w-fit mt-1 sm:mt-0">
      ...
      {isExpanded && (
        <div className="mb-4 space-y-4">
          ...
          {/* Coin Selection - Mobile optimized */}
              ...
              {filteredCoins.map((coin) => (
                ...
                >
                  <div className="flex items-center space-x-2 min-w-0">
                    <span className="font-medium flex-shrink-0">{coin.symbol}</span>
          ...
          {/* Add Custom Coin - Mobile optimized */}
          <div className="space-y-2">
            ...
            <div className="flex flex-col sm:flex-row space-y-2 sm:space-y-0 sm:space-x-2">
              ...
              <button
                ...
                className="px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-lg transition-colors text-sm flex-shrink-0"
              >
                Add
              </button>
            </div>
      ...
      <div className="mt-4 pt-4 border-t border-slate-600 flex flex-col space-y-2 sm:flex-row sm:items-center sm:justify-between sm:space-y-0">
