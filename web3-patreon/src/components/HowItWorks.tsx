export function HowItWorks() {
  const steps = [
    ...
    },
    {
      ...
      description: "Set up your creator profile with bio, social links, and support tiers",
      icon: (
        <svg className="w-8 h-8" fill="currentColor" viewBox="0 0 20 20">
    ...
    {
      number: "03",
      title: "Set Support Tiers",
      description: "Create multiple subscription levels with different benefits and pricing",
      icon: (
        <svg className="w-8 h-8" fill="currentColor" viewBox="0 0 20 20">
    ...
    },
    {
      ...
      description: "Fans can send tips or subscribe to your tiers with USDC/DAI",
      icon: (
        <svg className="w-8 h-8" fill="currentColor" viewBox="0 0 20 20">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Get started in minutes and begin building your Web3 creator economy
          </p>
        </div>
            ...
            <div key={index} className="relative">
              <div className="bg-white rounded-xl p-8 shadow-lg border border-gray-200">
                <div className="flex items-center justify-between mb-6">
                  <div className="w-16 h-16 bg-gradient-to-r from-purple-600 to-blue-600 rounded-lg flex items-center justify-center text-white">
                    {step.icon}
                  </div>
        ...
        <div className="text-center mt-12">
          <div className="bg-white rounded-xl p-8 shadow-lg border border-gray-200 max-w-2xl mx-auto">
            ...
            <p className="text-gray-600 mb-6">
              Join the future of creator economy. No platform fees, no censorship, just direct support from your fans.
            </p>
